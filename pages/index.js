...
export const getStaticProps = async () => {
  const consoleRes = await fetch(
    `https://shigeo-ecommerce.vercel.app//api/products/category/console`
  );
  const consoleData = await consoleRes.json();

  const laptopRes = await fetch(
    `https://shigeo-ecommerce.vercel.app//api/products/category/laptop`
  );
  const laptopData = await laptopRes.json();

  const monitorRes = await fetch(
    `https://shigeo-ecommerce.vercel.app//api/products/category/monitor`
  );
